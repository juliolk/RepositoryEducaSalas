...
public class XcpCommandButtonHandler extends ComponentHandler {
	...
	public XcpCommandButtonHandler(ComponentConfig config) {
		super(config);
	...
	public void onComponentCreated(FaceletContext ctx, UIComponent c, UIComponent parent) {
		...
		if (this._id != null) {
			...
			//			btn.setValueExpression("title", TagHandlerUtils.createValueExp(ctx, String.format("#{toolTip['%s']}", id), String.class));
			//			btn.setValueExpression("alt", TagHandlerUtils.createValueExp(ctx, String.format("#{toolTip['%s']}", id), String.class));

...
import com.adm.ejb.entity.SolPortalAfastamento;
...
@WebServlet("/docsolportalafastamento")
public class DocSolPortalAfastamentoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			MontaQuery mq = new MontaQuery("Select e from SolPortalAfastamento e");
			...
			if (!Util.isEmpty(list)) {
				SolPortalAfastamento p = (SolPortalAfastamento) list.get(0);

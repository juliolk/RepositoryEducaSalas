 ...
 */
public class XcpDataTableRenderer extends DataTableRenderer {
	...
	protected void encodeFilter(FacesContext context, DataTable table, UIColumn column) throws IOException {
		...
		String filterValue = params.containsKey(filterId) && !table.isReset() ? (String) params.get(filterId) : (String) table.getFilters().get(filterField);

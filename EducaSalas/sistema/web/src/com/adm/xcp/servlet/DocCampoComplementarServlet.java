...
@WebServlet("/doccampocomplementar")
public class DocCampoComplementarServlet extends HttpServlet implements com.adm.util.Constants {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			InputStream is = null;
			MontaQuery mq = new MontaQuery("Select e from FuncionariosColAnexos e");
